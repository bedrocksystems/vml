...
namespace Msr {
    ...
    enum RegisterId : uint32 {
        ...
        ID_AA64MMFR3_EL1 = build_msr_id(3, 0, 0, 7, 3),
        ID_AA64MMFR4_EL1 = build_msr_id(3, 0, 0, 7, 4),
