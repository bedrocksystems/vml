...
public:
    Msr_mrs(uint64 const esr) : _esr(esr) {}
...
public:
    Mcr_mrc(uint64 const esr) : _esr(esr) {}
...
public:
    Data_abort(uint64 const esr) : _esr(esr) {}
...
public:
    Instruction_abort(uint64 const esr) : _esr(esr) {}
