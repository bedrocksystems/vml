...
protected:
    void flush(const VcpuCtx*, const uint8, const uint32) const;
...
public:
    Id_pfr0(uint32 value) : Register("ID_PFR0_EL1", ID_PFR0_EL1, false, _reset_value(value)) {}
};
...
public:
    Id_pfr1(uint32 value) : Register("ID_PFR1_EL1", ID_PFR1_EL1, false, _reset_value(value)) {}
};
...
public:
    Ccsidr(Register& cs, uint64 const clidr, uint64 const* ccsidr)
        : Register_base("CCSIDR_EL1", CCSIDR_EL1), csselr(cs), clidr_el1(clidr) {
