...
public:
     ...
     */
    void register_callback(::Vuart::TxCallback *callback, ::Vuart::LifeCycleCallbacks *lifecycle_callbacks) {
        _callback = callback;
        _lifecycle_callbacks = lifecycle_callbacks;
    }

protected:
    ::Vuart::TxCallback *_callback{nullptr};                    /*!< Callback interface used to send chars (TX) */
